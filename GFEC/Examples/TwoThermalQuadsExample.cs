...
namespace GFEC
{
    public static class TwoThermalQuadsExample
    {
        ...
        private static Dictionary<int, Dictionary<int, int>> CreateConnectivity()
        {
            ...
            connectivity[2] = new Dictionary<int, int>() { { 1, 3 }, { 2, 4 }, { 3, 5 }, { 4, 6 } };
        ...
        public static Results RunStaticExample()
        {
            ...
            double[] externalForces = new double[] { 0, 0, 250.0, 250.0 };
