...
namespace GFEC
{
    public static class CoupledThermalStructural_0143L_0001fy
    {
        ...
        private const double offset = 1.20;
        ...
        private static Dictionary<int, Dictionary<int, int>> CreateConnectivity()
        {
            ...
            //}
            connectivity[113] = new Dictionary<int, int>() { { 1, 136 }, { 2, 13 } };
            connectivity[114] = new Dictionary<int, int>() { { 1, 137 }, { 2, 14 } };
            connectivity[115] = new Dictionary<int, int>() { { 1, 138 }, { 2, 15 } };
            return connectivity;
        }
        ...
        public static Results RunStaticExample()
        {
            ...
            externalForces3[135] = -1250.0;
            externalForces3[137] = -2500.0;
            externalForces3[139] = -2500.0;
            externalForces3[141] = -2500.0;
            externalForces3[143] = -2500.0;
            externalForces3[145] = -2500.0;
            externalForces3[147] = -2500.0;
            externalForces3[149] = -1250.0;
            ...
            ExportToFile.ExportGeometryDataWithTemperatures(Assembly.CalculateFinalNodalCoordinates(elementsAssembly.Nodes, fullStructuralSol1), fullThermalSol1, @"C:\Users\Public\Documents\Results1_0143L_0.001fy.dat");
            ExportToFile.ExportGeometryDataWithTemperatures(Assembly.CalculateFinalNodalCoordinates(elementsAssembly.Nodes, fullStructuralSol2), fullThermalSol2, @"C:\Users\Public\Documents\Results2_0143L_0.001fy.dat");
            ExportToFile.ExportGeometryDataWithTemperatures(Assembly.CalculateFinalNodalCoordinates(elementsAssembly.Nodes, fullStructuralSol3), fullThermalSol3, @"C:\Users\Public\Documents\Results3_0143L_0.001fy.dat");
            ExportToFile.ExportGeometryDataWithTemperatures(Assembly.CalculateFinalNodalCoordinates(elementsAssembly.Nodes, fullStructuralSol4), fullThermalSol4, @"C:\Users\Public\Documents\Results4_0143L_0.001fy.dat");
            ExportToFile.ExportGeometryDataWithTemperatures(Assembly.CalculateFinalNodalCoordinates(elementsAssembly.Nodes, fullStructuralSol5), fullThermalSol5, @"C:\Users\Public\Documents\Results5_0143L_0.001fy.dat");
